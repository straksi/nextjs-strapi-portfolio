						...
						<div className="portfolio-grid">
							{portfolio?.data.map(item => (
								<div className="portfolio-item" key={item.id}>
									...
									<Image fill className="portfolio-item__img"  sizes="100%" alt={item.attributes.title} src={item.attributes.image.data.attributes.formats.large.url} priority={true}
